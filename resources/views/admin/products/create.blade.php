...
@section('title', 'Tambah Produk Baru - Admin Mamitha Bakery')
...
<div class="container py-5">
    ...
    <div class="row mb-4">
        <div class="col-lg-8 mx-auto">
            ...
            <h2 class="fw-bold text-primary-custom">Tambah Produk Baru</h2>
            <p class="text-muted">Masukkan data produk baru di bawah ini.</p>
        </div>
    </div>
                ...
                <div class="card-body p-4">
                    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" id="name" class="form-control" placeholder="Contoh: Roti Sobek Coklat" value="{{ old('name') }}" required>
                        </div>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" name="price" id="price" class="form-control" placeholder="Contoh: 15000" min="0" value="{{ old('price') }}" required>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" class="form-control" rows="4" placeholder="Jelaskan isi produk, bahan, rasa, dll...">{{ old('description') }}</textarea>
                        </div>
